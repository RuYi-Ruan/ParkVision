...
export const dashboardHero: DashboardOverview = {
  eyebrow: "今日运营概览",
...
export const dashboardSpaceBlocks = [
  { title: "A-01 至 A-20", status: "空闲 8", camera: "A01", statusType: "free" as const },
  { title: "B-01 至 B-20", status: "占用 17", camera: "B02", statusType: "busy" as const },
  { title: "C-01 至 C-20", status: "巡检中", camera: "C03", statusType: "warning" as const },
];

export const dashboardRecentRecords: RecentRecordItem[] = [
  { id: 1, plate: "粤B·A2138", time: "09:12", gate: "东入口" },
  { id: 2, plate: "粤B·Q8M61", time: "09:07", gate: "南入口" },
  { id: 3, plate: "粤B·7P221", time: "08:55", gate: "西入口" },
  { id: 4, plate: "粤B·D9C12", time: "08:41", gate: "地下车库" },
];
